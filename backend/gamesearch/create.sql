create table tb_game (id bigserial not null, platform smallint, title varchar(255), genre_id bigint, primary key (id));
create table tb_genre (id bigserial not null, name varchar(255), primary key (id));
create table tb_record (id bigserial not null, age integer, moment timestamp(6) with time zone, name varchar(255), game_id bigint, primary key (id));
